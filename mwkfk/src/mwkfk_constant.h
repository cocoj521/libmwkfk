#ifndef MWKFK_CONSTANT_H
#define MWKFK_CONSTANT_H
//global config items
...
//message.send.max.retries是全局参数,不是topic级的...
...
#define RD_KAFKA_CONFIG_CLIENT_ID_VALUE "MWkfk"
...
//PRODUCER CONFIG
#define RD_KAFKA_SDK_FORCE_KAFKA_FLUSH_TIMEOUT_MIN  100     //调用rd_kafka_flush,每次最小等待时间
#define RD_KAFKA_SDK_FORCE_KAFKA_FLUSH_TIMEOUT_MAX  1000    //调用rd_kafka_flush,每次最大等待时间
#define RD_KAFKA_SDK_MAX_OUTQUE_SIZE				10000	//允许RDKAFKA OUTQUE的最大值,强过该值将强制调用flush
#define RD_KAFKA_MSG_PASSTHROUGH	0x00		//Rdkafka will not copy nor free ,just passthrough the payload.
